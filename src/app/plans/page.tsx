    ...
    <div className="mx-auto w-full max-w-6xl px-4 py-8 sm:px-6">
      <div className="rounded-card border border-border bg-surface p-5">
        ...
        <div className="mt-3 flex flex-wrap gap-2">
          ...
          />
          <button type="button" onClick={compareAll} className="btn btn-secondary btn-sm">
            Compare all
          </button>
          <button type="button" onClick={clearCompare} className="btn btn-secondary btn-sm">
            Clear comparison
          </button>
        </div>
        ...
        <div className="mt-3 flex flex-wrap items-center gap-2 border-t border-border pt-3">
          ...
          />
          <button type="button" onClick={handleOpenFriendLink} className="btn btn-secondary btn-sm">
            Open
          </button>
        </div>
      </div>
